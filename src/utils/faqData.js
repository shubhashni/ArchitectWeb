export const fData = [
    ...
    },
    {
      ...
      ans: 'The time it takes to complete a project, depends on the scope of work and the complexity of a project. To determine the turnaround time for your project, please send us a brief description of your project along with any documents and requirements you have. We will calculate the TAT and inform you.',
    },
   
    {
      id: 'qa1qa8',
      ques: 'How much do 3D rendering services cost?',
      ans: "The time it takes to complete an order for this service depends on the scope of work and the complexity of a project. To learn the exact TAT for your project, please send us a brief, we will calculate the turnaround time for your order based on your requirements.",
    },
    {
      id: 'qa1qa9',
      ques: 'How much does it cost?',
      ans: 'For an exact price estimate, please send us a brief description of your project, along with any documents and requirements. You will get a quote within 1 day.',
    },
