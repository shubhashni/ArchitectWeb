"use strict";
(self.webpackChunkam_arc = self.webpackChunkam_arc || []).push([[237], {
    4237: function(e, t, r) {
        r.r(t),
        r.d(t, {
            Bidi: function() {
            ...
            var e = function() {
              ...
              , t = function(e) {
                ...
                !(n < 0 || n >= r)) {
                    ...
                    return o >= 55296 && o <= 56319 && r > n + 1 && ((a = t.charCodeAt(n + 1)) >= 56320 && a <= 57343) ? 1024 * (o - 55296) + a - 56320 + 65536 : o
                }
            };
        ...
        function U(e, t, r) {
            for (; ; ) {
                ...
                if (i < 256)
                    ...
                    for (n = S(e, l[i -= 257], c[i]),
                    a = T(e, r),
                    s = o = e.destLen - S(e, h[a], f[a]); s < o + n; ++s)
        ...
        ,
        L.prototype.addBezier = function(e, t, r, n, a, o, s, i) {
            var u = [e, t]
              , p = [r, n]
              , l = [a, o]
              , c = [s, i];
            ...
            for (var h = 0; h <= 1; h++) {
                ...
                if (0 !== d) {
                    ...
                    if (!(v < 0)) {
                        ...
                        0 < m && m < 1 && (0 === h && this.addX(R(u[h], p[h], l[h], c[h], m)),
                        1 === h && this.addY(R(u[h], p[h], l[h], c[h], m)));
                        var y = (-f - Math.sqrt(v)) / (2 * d);
                        0 < y && y < 1 && (0 === h && this.addX(R(u[h], p[h], l[h], c[h], y)),
                    ...
                    if (0 === f)
                        continue;
                    var b = -g / f;
                    0 < b && b < 1 && (0 === h && this.addX(R(u[h], p[h], l[h], c[h], b)),
                    1 === h && this.addY(R(u[h], p[h], l[h], c[h], b)))
                }
            }
        }
        ,
        L.prototype.addQuad = function(e, t, r, n, a, o) {
            var s = e + .6666666666666666 * (r - e)
              , i = t + 2 / 3 * (n - t)
              , u = s + 1 / 3 * (a - e)
              , p = i + 1 / 3 * (o - t);
        ...
        ,
        C.prototype.curveTo = C.prototype.bezierCurveTo = function(e, t, r, n, a, o) {
            this.commands.push({
                type: "C",
                x1: e,
                y1: t,
        ...
        ,
        C.prototype.quadTo = C.prototype.quadraticCurveTo = function(e, t, r, n) {
            this.commands.push({
                type: "Q",
                x1: e,
                y1: t,
        ...
        ,
        C.prototype.close = C.prototype.closePath = function() {
            this.commands.push({
                type: "Z"
            })
        }
        ...
        C.prototype.getBoundingBox = function() {
            for (var e = new L, t = 0, r = 0, n = 0, a = 0, o = 0; o < this.commands.length; o++) {
        ...
        ,
        C.prototype.toDOMElement = function(e) {
        ...
        B.BYTE = function(e) {
            return I.argument(e >= 0 && e <= 255, "Byte value should be between 0 and 255."),
            [e]
        }
        ,
        F.BYTE = A(1),
        ...
        F.LONGDATETIME = A(8),
        B.TAG = function(e) {
            return I.argument(4 === e.length, "Tag should be exactly 4 ASCII characters."),
        ...
        F.SID = F.USHORT,
        B.NUMBER = function(e) {
            return e >= -107 && e <= 107 ? [e + 139] : e >= 108 && e <= 1131 ? [247 + ((e -= 108) >> 8), 255 & e] : e >= -1131 && e <= -108 ? [251 + ((e = -e - 108) >> 8), 255 & e] : e >= -32768 && e <= 32767 ? B.NUMBER16(e) : B.NUMBER32(e)
        }
        ,
        F.NUMBER = function(e) {
        ...
        B.REAL = function(e) {
            ...
            for (var u = [30], p = 0, l = (a += 1 & a.length ? "f" : "ff").length; p < l; p += 2)
        ...
        ;
        var N, H = "function" == typeof WeakMap && new WeakMap;
        function z(e) {
            return e >= -128 && e <= 127
        }
        function W(e, t, r) {
            for (var n = 0, a = e.length; t < a && n < 64 && 0 === e[t]; )
                ++t,
                ++n;
            return r.push(128 | n - 1),
            t
        }
        function q(e, t, r) {
            for (var n = 0, a = e.length, o = t; o < a && n < 64; ) {
                var s = e[o];
                if (!z(s) || 0 === s && o + 1 < a && 0 === e[o + 1])
                    break;
                ++o,
                ++n
            }
        ...
        B.VARDELTAS = function(e) {
            for (var t = 0, r = []; t < e.length; ) {
                var n = e[t];
                t = 0 === n ? W(e, t, r) : n >= -128 && n <= 127 ? q(e, t, r) : _(e, t, r)
            }
            return r
        }
        ,
        ...
        B.OPERAND = function(e, t) {
            ...
            if (Array.isArray(t))
                for (var n = 0; n < t.length; n += 1)
                    I.argument(e.length === t.length, "Not enough arguments given for type" + t),
                    r = r.concat(B.OPERAND(e[n], t[n]));
            else if ("SID" === t)
                r = r.concat(B.NUMBER(e));
            else if ("offset" === t)
                r = r.concat(B.NUMBER32(e));
            else if ("number" === t)
                r = r.concat(B.NUMBER(e));
            else {
                if ("real" !== t)
        ...
        function Q(e) {
            1 === e.format ? V.call(this, "coverageTable", [{
                ...
                type: "USHORT",
                value: 1
            }].concat(Y("glyph", e.glyphs))) : 2 === e.format ? V.call(this, "coverageTable", [{
                name: "coverageFormat",
                type: "USHORT",
                value: 2
            }].concat(Z("rangeRecord", e.ranges, (function(e) {
                return [{
                    name: "startGlyphID",
                    type: "USHORT",
                    value: e.start
            ...
            )))) : I.assert(!1, "Coverage format must be 1 or 2.")
        }
        function K(e) {
            V.call(this, "scriptListTable", Z("scriptRecord", e, (function(e, t) {
                var r = e.script
                  , n = r.defaultLangSys;
                return I.assert(!!n, "Unable to write GSUB: script " + e.tag + " has no default language system."),
                [{
                    name: "scriptTag" + t,
                    type: "TAG",
                    value: e.tag
                    ...
                    }].concat(Z("langSys", r.langSysRecords, (function(e, t) {
                        var r = e.langSys;
                        return [{
                            name: "langSysTag" + t,
                            type: "TAG",
        ...
        function J(e) {
            V.call(this, "featureListTable", Z("featureRecord", e, (function(e, t) {
                var r = e.feature;
                return [{
                    name: "featureTag" + t,
                    type: "TAG",
        ...
        function $(e, t) {
            V.call(this, "lookupListTable", j("lookup", e, (function(e) {
                var r = t[e.lookupType];
                return I.assert(!!r, "Unable to write GSUB lookup type " + e.lookupType + " tables."),
                new V("lookupTable",[{
                    name: "lookupType",
                    type: "USHORT",
                    value: e.lookupType
        ...
        B.OBJECT = function(e) {
            var t = B[e.type];
            return I.argument(void 0 !== t, "No encoding function for type " + e.type),
            t(e.value)
        }
        ,
        F.OBJECT = function(e) {
            var t = F[e.type];
            return I.argument(void 0 !== t, "No sizeOf function for type " + e.type),
            t(e.value)
        }
        ,
        B.TABLE = function(e) {
            for (var t = [], r = e.fields.length, n = [], a = [], o = 0; o < r; o += 1) {
                var s = e.fields[o]
                  , i = B[s.type];
                I.argument(void 0 !== i, "No encoding function for field type " + s.type + " (" + s.name + ")");
                var u = e[s.name];
                void 0 === u && (u = s.value);
                var p = i(u);
                "TABLE" === s.type ? (a.push(t.length),
                t = t.concat([0, 0]),
                n.push(p)) : t = t.concat(p)
            }
        ...
        F.TABLE = function(e) {
            for (var t = 0, r = e.fields.length, n = 0; n < r; n += 1) {
                var a = e.fields[n]
                  , o = F[a.type];
                I.argument(void 0 !== o, "No sizeOf function for field type " + a.type + " (" + a.name + ")");
                var s = e[a.name];
                void 0 === s && (s = a.value),
                t += o(s),
                "TABLE" === a.type && (t += 2)
        ...
        se.prototype.parseListOfLists = function(e) {
            for (var t = this.parseOffset16List(), r = t.length, n = this.relativeOffset, a = new Array(r), o = 0; o < r; o++) {
                ...
                if (0 !== s)
                    ...
                    e) {
                        for (var i = this.parseOffset16List(), u = new Array(i.length), p = 0; p < i.length; p++)
                            this.relativeOffset = s + i[p],
                            u[p] = e.call(this);
                        a[o] = u
                    } else
        ...
        se.prototype.parseScriptList = function() {
            return this.parsePointer(se.recordList({
                tag: se.tag,
                script: se.pointer({
        ...
        se.prototype.parseLookupList = function(e) {
            return this.parsePointer(se.list(se.pointer((function() {
                ...
                I.argument(1 <= t && t <= 9, "GPOS/GSUB lookup type " + t + " unknown.");
        ...
        se.prototype.parseFeatureVariationsList = function() {
            return this.parsePointer32((function() {
                var e = this.parseUShort()
                  , t = this.parseUShort();
                return I.argument(1 === e && t < 1, "GPOS/GSUB feature variations table unknown."),
        ...
        var le = {
            parse: function(e, t) {
                ...
                12 === r.format)
                    !function(e, t) {
                        ...
                        e.glyphIndexMap = {};
                        for (var n = 0; n < r; n += 1)
                            for (var a = t.parseULong(), o = t.parseULong(), s = t.parseULong(), i = a; i <= o; i += 1)
                                e.glyphIndexMap[i] = s,
                                s++
                    }(r, i);
                else {
                    ...
                    !function(e, t, r, n, a) {
                        ...
                        t.skip("uShort", 3),
                        e.glyphIndexMap = {};
                        for (var s = new ue.Parser(r,n + a + 14), i = new ue.Parser(r,n + a + 16 + 2 * o), u = new ue.Parser(r,n + a + 16 + 4 * o), p = new ue.Parser(r,n + a + 16 + 6 * o), l = n + a + 16 + 8 * o, c = 0; c < o - 1; c += 1)
                            for (var h = void 0, f = s.parseUShort(), d = i.parseUShort(), g = u.parseShort(), v = p.parseUShort(), m = d; m <= f; m += 1)
                                0 !== v ? (l = p.offset + p.relativeOffset - 2,
                                l += v,
                                l += 2 * (m - d),
                                0 !== (h = ue.getUShort(r, l)) && (h = h + g & 65535)) : h = m + g & 65535,
                                e.glyphIndexMap[m] = h
                    }(r, i, e, t, n)
                }
                return r
            ...
            make: function(e) {
                ...
                for (t = 0; t < i; t += 1) {
                    var g = a.segments[t];
                    g.end <= 65535 && g.start <= 65535 ? (p = p.concat({
                        name: "end_" + t,
                        type: "USHORT",
                        value: g.end
                    }),
                    ...
                    !r && void 0 !== g.glyphIndex && (d = (d = (d = d.concat({
                        name: "cmap12Start_" + t,
                        type: "ULONG",
                        value: g.start
                    })).concat({
        ...
        function ye(e) {
            ...
            case 2:
                ...
                for (var t = 0; t < e.numberOfGlyphs; t++)
                    e.glyphNameIndex[t] < de.length ? this.names[t] = de[e.glyphNameIndex[t]] : this.names[t] = e.names[e.glyphNameIndex[t] - de.length];
                break;
            case 2.5:
                this.names = new Array(e.numberOfGlyphs);
        ...
        function be(e, t) {
            t.lowMemory ? function(e) {
                ...
                for (var i = 0; i < e.glyphs.length; i += 1)
                    t = e.glyphs.get(i),
                    e.cffEncoding ? e.isCIDFont ? t.name = "gid" + i : t.name = e.cffEncoding.charset[i] : e.glyphNames.names && (t.name = e.glyphNames.glyphIndexToName(i))
            }(e)
        }
        ...
        function ke(e, t) {
            ...
            Array.isArray(t))
                for (var r = 0; r < t.length; r++) {
                    var n = t[r];
                    n.path.unitsPerEm = e.unitsPerEm,
                    this.glyphs[r] = n
                }
        ...
        Se.prototype.bindConstructorValues = function(e) {
            ...
            Object.defineProperty(this, "path", function(e, t) {
                var r = t || new C;
                return {
                    configurable: !0,
                    get: function() {
        ...
        Se.prototype.getPath = function(e, t, r, n, a) {
            ...
            var i = n.xScale
              , u = n.yScale;
            if (n.hinting && a && a.hinting && (s = this.path && a.hinting.exec(this, r)),
            s)
            ...
            for (var l = new C, c = 0; c < o.length; c += 1) {
                var h = o[c];
        ...
        Se.prototype.getMetrics = function() {
            ...
            return isFinite(o.xMin) || (o.xMin = 0),
        ...
        function Re(e, t, r) {
            var n, a, o = [], s = [], i = ue.getCard16(e, t);
            if (0 !== i) {
                var u = ue.getByte(e, t + 2);
                n = t + (i + 1) * u + 2;
                for (var p = t + 3, l = 0; l < i + 1; l += 1)
                    o.push(ue.getOffset(e, p, u)),
                    p += u;
                a = n + o[i]
            } else
                a = t + 2;
            ...
            for (var n, a = {}, o = 0; o < t.length; o += 1) {
                ...
                if (Array.isArray(s.type)) {
                    ...
                    for (var u = 0; u < s.type.length; u++)
                        void 0 === (n = void 0 !== e[s.op] ? e[s.op][u] : void 0) && (n = void 0 !== s.value && void 0 !== s.value[u] ? s.value[u] : null),
        ...
        function Ge(e, t) {
            return De(Ce(e, 0, e.byteLength), Ie, t)
        }
        function Be(e, t, r, n) {
            return De(Ce(e, t, r), Me, n)
        }
        function Fe(e, t, r, n) {
            for (var a = [], o = 0; o < r.length; o += 1) {
                var s = Ge(new DataView(new Uint8Array(r[o]).buffer), n);
                s._subrs = [],
                s._subrsBias = 0,
                s._defaultWidthX = 0,
                s._nominalWidthX = 0;
                ...
                if (0 !== i && 0 !== u) {
                    var p = Be(e, u + t, i, n);
                    if (s._defaultWidthX = p.defaultWidthX,
                    s._nominalWidthX = p.nominalWidthX,
                    0 !== p.subrs) {
                        var l = Re(e, u + p.subrs + t);
                        s._subrs = l.objects,
                        s._subrsBias = Ee(s._subrs)
                    }
                    s._privateDict = p
                }
                a.push(s)
        ...
        function Ae(e, t, r) {
            var n, a, o, s, i, u, p, l, c = new C, h = [], f = 0, d = !1, g = !1, v = 0, m = 0;
            if (e.isCIDFont) {
            ...
            return function r(p) {
                for (var y, b, k, U, O, E, R, L, C, w, D, I, M = 0; M < p.length; ) {
                    var G = p[M];
                    switch (M += 1,
                    G) {
                    case 1:
                    ...
                    case 12:
                        ...
                        case 37:
                            ...
                            D = C + h.shift(),
                            I = w + h.shift(),
                            Math.abs(D - v) > Math.abs(I - m) ? v = D + h.shift() : m = I + h.shift(),
                            c.curveTo(n, a, o, s, R, L),
                            c.curveTo(C, w, D, I, v, m);
                            break;
                        default:
                            console.log("Glyph " + t.index + ": unknown operator 1200" + G),
                            h.length = 0
                        }
                        break;
                    case 14:
                        h.length > 0 && !d && (x = h.shift() + l,
                        d = !0),
                        g && (c.closePath(),
                        g = !1);
                        break;
                    ...
                    case 31:
                        ...
                        break;
                    default:
                        G < 32 ? console.log("Glyph " + t.index + ": unknown operator " + G) : G < 247 ? h.push(G - 139) : G < 251 ? (y = p[M],
                        M += 1,
                        h.push(256 * (G - 247) + y + 108)) : G < 255 ? (y = p[M],
                        M += 1,
                        h.push(256 * -(G - 251) - y - 108)) : (y = p[M],
                        b = p[M + 1],
                        k = p[M + 2],
                        U = p[M + 3],
                        M += 4,
                        h.push((y << 24 | b << 16 | k << 8 | U) / 65536))
                    }
                }
            }(r),
            t.advanceWidth = x,
        ...
        function Pe(e, t) {
            var r, n = ce.indexOf(e);
            return n >= 0 && (r = n),
            (n = t.indexOf(e)) >= 0 ? r = n + ce.length : (r = ce.length + t.length,
            t.push(e)),
            r
        }
        function Ne(e, t, r) {
            for (var n = {}, a = 0; a < e.length; a += 1) {
                var o = e[a]
                  , s = t[o.name];
                void 0 !== s && !Oe(s, o.value) && ("SID" === o.type && (s = Pe(s, r)),
                n[o.op] = {
                    name: o.name,
                    type: o.type,
                    value: s
        ...
        var qe = {
            parse: function(e, t, r, n) {
                ...
                var a = function(e, t) {
                    var r = {};
                    return r.formatMajor = ue.getCard8(e, t),
                  ...
                  , u = Re(e, i.endOffset);
                r.gsubrs = u.objects,
                r.gsubrsBias = Ee(r.gsubrs);
                var p = Fe(e, t, s.objects, i.objects);
                if (1 !== p.length)
                    throw new Error("CFF table has too many fonts in 'FontSet' - count of fonts NameIndex.length = " + p.length);
                var l = p[0];
                if (r.tables.cff.topDict = l,
                l._privateDict && (r.defaultWidthX = l._privateDict.defaultWidthX,
                ...
                r.isCIDFont) {
                    ...
                    var f = Re(e, c += t)
                      , d = Fe(e, t, f.objects, i.objects);
                    l._fdArray = d,
                    h += t,
                    l._fdSelect = function(e, t, r, n) {
                        var a, o = [], s = new ue.Parser(e,t), i = s.parseCard8();
                        if (0 === i)
                            for (var u = 0; u < r; u++) {
                                if ((a = s.parseCard8()) >= n)
                ...
                var g, v = t + l.private[1], m = Be(e, v, l.private[0], i.objects);
                if (r.defaultWidthX = m.defaultWidthX,
                r.nominalWidthX = m.nominalWidthX,
                0 !== m.subrs) {
                    var y = v + m.subrs
                      , b = Re(e, y);
                    r.subrs = b.objects,
                    r.subrsBias = Ee(r.subrs)
                } else
                    r.subrs = [],
                    r.subrsBias = 0;
                n.lowMemory ? (g = function(e, t) {
                    var r, n, a = [], o = ue.getCard16(e, t);
                    if (0 !== o) {
                        var s = ue.getByte(e, t + 2);
                        r = t + (o + 1) * s + 2;
                        for (var i = t + 3, u = 0; u < o + 1; u += 1)
                            a.push(ue.getOffset(e, i, s)),
                            i += s;
                        n = r + a[o]
                    } else
                        n = t + 2;
                ...
                r.nGlyphs = g.offsets.length) : (g = Re(e, t + l.charStrings),
                r.nGlyphs = g.objects.length);
                var x = function(e, t, r, n) {
                    var a, o, s = new ue.Parser(e,t);
                    r -= 1;
                    var i = [".notdef"]
                      , u = s.parseCard8();
                    if (0 === u)
                ...
                if (0 === l.encoding ? r.cffEncoding = new me(he,x) : 1 === l.encoding ? r.cffEncoding = new me(fe,x) : r.cffEncoding = function(e, t, r) {
                    var n, a = {}, o = new ue.Parser(e,t), s = o.parseCard8();
                    if (0 === s)
                        ...
                        n = 1;
                        for (var l = 0; l < p; l += 1)
                            for (var c = o.parseCard8(), h = o.parseCard8(), f = c; f <= c + h; f += 1)
                                a[f] = n,
                                n += 1
                    }
                    return new me(a,r)
                ...
                n.lowMemory)
                    r._push = function(n) {
                        ...
                        r.glyphs.push(n, Ue.cffGlyphLoader(r, n, Ae, a))
                    }
                    ;
                else
                    for (var S = 0; S < r.nGlyphs; S += 1) {
                        var T = g.objects[S];
                        r.glyphs.push(S, Ue.cffGlyphLoader(r, S, Ae, T))
                    }
            },
            make: function(e, t) {
                for (var r, n = new ee.Table("CFF ",[{
                    name: "header",
                    type: "RECORD"
                }, {
                    name: "nameIndex",
                ...
                n.charsets = function(e, t) {
                    for (var r = new ee.Record("Charsets",[{
                        name: "format",
                        type: "Card8",
                        value: 0
                    }]), n = 0; n < e.length; n += 1) {
        ...
        var _e = {
            parse: function(e, t) {
                ...
                I.argument(1594834165 === r.magicNumber, "Font header has wrong magic number."),
        ...
        var Ve = {
            parse: function(e, t, r, n, a, o, s) {
                s.lowMemory ? function(e, t, r, n, a) {
                    e._hmtxTableData = {};
                    for (var o, s, i = new ue.Parser(t,r), u = 0; u < a; u += 1)
                        u < n && (o = i.parseUShort(),
                        s = i.parseShort()),
                        e._hmtxTableData[u] = {
                            advanceWidth: o,
        ...
        var Ye = {
            ...
            parse: function(e, t) {
                ...
                for (var a = r.parseULong(), o = [], s = 0; s < a; s++) {
                    for (var i = "", u = t + r.parseUShort(), p = r.parseUShort(), l = u; l < u + p; ++l)
        ...
        var it = {
            parse: function(e, t, r) {
                for (var n = {}, a = new ue.Parser(e,t), o = a.parseUShort(), s = a.parseUShort(), i = a.offset + a.parseUShort(), u = 0; u < s; u++) {
                    var p = a.parseUShort()
                      , l = a.parseUShort()
                      , c = a.parseUShort()
                      , h = a.parseUShort()
                    ...
                    if (void 0 !== m && void 0 !== v) {
                        var y = void 0;
                        if (y = m === et ? G.UTF16(e, i + g, d) : G.MACSTRING(e, i + g, d, m)) {
                            var b = n[f];
                            void 0 === b && (b = n[f] = {}),
                            b[v] = y
                        }
            ...
            make: function(e, t) {
                ...
                for (var u = at(Qe), p = at(Je), l = [], c = [], h = 0; h < n.length; h++) {
                    var f = a[r = n[h]];
                    for (var d in f) {
                        var g = f[d]
                          , v = 1
        ...
        var lt = {
            parse: function(e, t) {
                var r = {}
                  , n = new ue.Parser(e,t);
                switch (r.version = n.parseVersion(),
        ...
        ct[1] = function() {
            ...
            } : void I.assert(!1, "0x" + e.toString(16) + ": lookup type 1 format must be 1 or 2.")
        }
        ,
        ct[2] = function() {
            var e = this.parseUShort();
            return I.argument(1 === e, "GSUB Multiple Substitution Subtable identifier-format must be 1"),
            {
                substFormat: e,
                coverage: this.parsePointer(se.coverage),
        ...
        ct[3] = function() {
            var e = this.parseUShort();
            return I.argument(1 === e, "GSUB Alternate Substitution Subtable identifier-format must be 1"),
            {
                substFormat: e,
                coverage: this.parsePointer(se.coverage),
        ...
        ct[4] = function() {
            var e = this.parseUShort();
            return I.argument(1 === e, "GSUB ligature table identifier-format must be 1"),
            {
                substFormat: e,
                coverage: this.parsePointer(se.coverage),
        ...
        ct[5] = function() {
            ...
            I.assert(!1, "0x" + e.toString(16) + ": lookup type 5 format must be 1, 2 or 3.")
        }
        ,
        ct[6] = function() {
            var e = this.offset + this.relativeOffset
            ...
            return 1 === t ? {
                ...
                lookupRecords: this.parseRecordList(ht)
            } : void I.assert(!1, "0x" + e.toString(16) + ": lookup type 6 format must be 1, 2 or 3.")
        }
        ,
        ct[7] = function() {
            var e = this.parseUShort();
            I.argument(1 === e, "GSUB Extension Substitution subtable identifier-format must be 1");
            var t = this.parseUShort()
        ...
        ct[8] = function() {
            var e = this.parseUShort();
            return I.argument(1 === e, "GSUB Reverse Chaining Contextual Single Substitution Subtable identifier-format must be 1"),
            {
                substFormat: e,
                coverage: this.parsePointer(se.coverage),
                backtrackCoverage: this.parseList(se.pointer(se.coverage)),
        ...
        ,
        ft[2] = function(e) {
            return I.assert(1 === e.substFormat, "Lookup type 2 substFormat must be 1."),
            new ee.Table("substitutionTable",[{
                name: "substFormat",
                type: "USHORT",
                value: 1
                ...
                type: "TABLE",
                value: new ee.Coverage(e.coverage)
            }].concat(ee.tableList("seqSet", e.sequences, (function(e) {
                return new ee.Table("sequenceSetTable",ee.ushortList("sequence", e))
            }
            ))))
        }
        ,
        ft[3] = function(e) {
            return I.assert(1 === e.substFormat, "Lookup type 3 substFormat must be 1."),
            new ee.Table("substitutionTable",[{
                name: "substFormat",
                type: "USHORT",
                value: 1
        ...
        ,
        ft[4] = function(e) {
            return I.assert(1 === e.substFormat, "Lookup type 4 substFormat must be 1."),
            new ee.Table("substitutionTable",[{
                name: "substFormat",
                type: "USHORT",
                value: 1
        ...
        ft[6] = function(e) {
            if (1 === e.substFormat)
                return new ee.Table("chainContextTable",[{
                    name: "substFormat",
                    type: "USHORT",
                    value: e.substFormat
                }, {
                    ...
                    type: "TABLE",
                    value: new ee.Coverage(e.coverage)
                }].concat(ee.tableList("chainRuleSet", e.chainRuleSets, (function(e) {
                    return new ee.Table("chainRuleSetTable",ee.tableList("chainRule", e, (function(e) {
                        var t = ee.ushortList("backtrackGlyph", e.backtrack, e.backtrack.length).concat(ee.ushortList("inputGlyph", e.input, e.input.length + 1)).concat(ee.ushortList("lookaheadGlyph", e.lookahead, e.lookahead.length)).concat(ee.ushortList("substitution", [], e.lookupRecords.length));
                        ...
                        new ee.Table("chainRuleTable",t)
                    }
                    )))
                }
                ))));
            if (2 === e.substFormat)
                I.assert(!1, "lookup type 6 format 2 is not yet supported.");
                ...
                new ee.Table("chainContextTable",t)
            }
            I.assert(!1, "lookup type 6 format must be 1, 2 or 3.")
        }
        ;
        var dt = {
            parse: function(e, t) {
                var r = new se(e,t = t || 0)
                  , n = r.parseVersion(1);
                return I.argument(1 === n || 1.1 === n, "Unsupported GSUB table version."),
                1 === n ? {
                    version: n,
        ...
        function bt(e) {
            ...
            for (var n = [], a = [], o = t.sizeOf() + yt().sizeOf() * t.numTables; o % 4 !== 0; )
                o += 1,
                a.push({
                    name: "padding",
                    type: "BYTE",
            ...
            for (var s = 0; s < e.length; s += 1) {
                var i = e[s];
                I.argument(4 === i.tableName.length, "Table name" + i.tableName + " is invalid.");
                var u = i.sizeOf()
                ...
                o += u,
                I.argument(!isNaN(o), "Something went wrong calculating the offset."); o % 4 !== 0; )
                    o += 1,
                    a.push({
                        name: "padding",
                        type: "BYTE",
        ...
        var Tt = {
            ...
            fontToTable: function(e) {
                ...
                var I = []
                  ...
                  , A = e.metas && Object.keys(e.metas).length > 0 ? gt.make(e.metas) : void 0
                  , P = [x, S, T, k, M, O, B, F, U];
                G && P.push(G),
                e.tables.gsub && P.push(dt.make(e.tables.gsub)),
                A && P.push(A);
                for (var N = bt(P), H = mt(N.encode()), z = N.fields, W = !1, q = 0; q < z.length; q += 1)
                    if ("head table" === z[q].name) {
                        z[q].value.checkSumAdjustment = 2981146554 - H,
                        W = !0;
                        break
                    }
                if (!W)
        ...
        function Mt(e, t, r, n, a) {
            var o;
            return (t & n) > 0 ? (o = e.parseByte(),
            0 === (t & a) && (o = -o),
            o = r + o) : o = (t & a) > 0 ? r : r + e.parseShort(),
            o
        }
        function Gt(e, t, r) {
            var n, a, o = new ue.Parser(t,r);
            if (e.numberOfContours = o.parseShort(),
            e._xMin = o.parseShort(),
            e._yMin = o.parseShort(),
            e._xMax = o.parseShort(),
            e._yMax = o.parseShort(),
            e.numberOfContours > 0) {
                for (var s = e.endPointIndices = [], i = 0; i < e.numberOfContours; i += 1)
                ...
                for (var l = 0; l < p; l += 1)
                    ...
                    (8 & a) > 0)
                        for (var c = o.parseByte(), h = 0; h < c; h += 1)
                            n.push(a),
                            l += 1;
                if (I.argument(n.length === p, "Bad flags."),
                s.length > 0) {
                    var f, d = [];
                    if (p > 0) {
                        for (var g = 0; g < p; g += 1)
                        ...
                        for (var v = 0, m = 0; m < p; m += 1)
                            a = n[m],
                            (f = d[m]).x = Mt(o, a, v, 2, 16),
                            v = f.x;
                        for (var y = 0, b = 0; b < p; b += 1)
                            a = n[b],
                            (f = d[b]).y = Mt(o, a, y, 4, 32),
                            y = f.y
                    }
                    e.points = d
                } else
                ...
                for (var x = !0; x; ) {
                    ...
                    (1 & n) > 0 ? (2 & n) > 0 ? (S.dx = o.parseShort(),
                    S.dy = o.parseShort()) : S.matchedPoints = [o.parseUShort(), o.parseUShort()] : (2 & n) > 0 ? (S.dx = o.parseChar(),
                    S.dy = o.parseChar()) : S.matchedPoints = [o.parseByte(), o.parseByte()],
                    (8 & n) > 0 ? S.xScale = S.yScale = o.parseF2Dot14() : (64 & n) > 0 ? (S.xScale = o.parseF2Dot14(),
                    S.yScale = o.parseF2Dot14()) : (128 & n) > 0 && (S.xScale = o.parseF2Dot14(),
        ...
        function Ft(e) {
            ...
            for (var r = function(e) {
                ...
                return I.argument(0 === r.length, "There are still points left in the current contour."),
                t
            }(e), n = 0; n < r.length; ++n) {
                var a = r[n]
                  , o = null
        ...
        Et.prototype = {
            ...
            getLangSysTable: function(e, t, r) {
                ...
                if (n) {
                    ...
                    if (r) {
                        ...
                        return n.langSysRecords.splice(-1 - a, 0, o),
                        o.langSys
                    }
                }
            },
            getFeatureTable: function(e, t, r, n) {
                ...
                if (a) {
                    ...
                    if (n) {
                        var p = i.length;
                        return I.assert(0 === p || r >= i[p - 1].tag, "Features must be added in alphabetical order."),
                        o = {
                            tag: r,
                            feature: {
                                params: 0,
            ...
            getLookupTables: function(e, t, r, n, a) {
                var o = this.getFeatureTable(e, t, r, a)
                  , s = [];
                if (o) {
                    for (var i, u = o.lookupListIndexes, p = this.font.tables[this.tableName].lookups, l = 0; l < u.length; l++)
        ...
        ,
        Lt.prototype.getSingle = function(e, t, r) {
        ...
        ,
        Lt.prototype.getMultiple = function(e, t, r) {
        ...
        ,
        Lt.prototype.getAlternates = function(e, t, r) {
            for (var n = [], a = this.getLookupTables(t, r, e, 3), o = 0; o < a.length; o++)
                for (var s = a[o].subtables, i = 0; i < s.length; i++)
                    for (var u = s[i], p = this.expandCoverage(u.coverage), l = u.alternateSets, c = 0; c < p.length; c++)
                        n.push({
                            sub: p[c],
                            by: l[c]
                        });
        ...
        ,
        Lt.prototype.getLigatures = function(e, t, r) {
        ...
        ,
        Lt.prototype.addSingle = function(e, t, r, n) {
            ...
            I.assert(1 === a.coverage.format, "Single: unable to modify coverage table format " + a.coverage.format);
            var o = t.sub
        ...
        ,
        Lt.prototype.addMultiple = function(e, t, r, n) {
            I.assert(t.by instanceof Array && t.by.length > 1, 'Multiple: "by" must be an array of two or more ids');
            ...
            I.assert(1 === a.coverage.format, "Multiple: unable to modify coverage table format " + a.coverage.format);
            var o = t.sub
              , s = this.binSearch(a.coverage.glyphs, o);
            s < 0 && (s = -1 - s,
            a.coverage.glyphs.splice(s, 0, o),
        ...
        ,
        Lt.prototype.addAlternate = function(e, t, r, n) {
            ...
            I.assert(1 === a.coverage.format, "Alternate: unable to modify coverage table format " + a.coverage.format);
            var o = t.sub
              , s = this.binSearch(a.coverage.glyphs, o);
            s < 0 && (s = -1 - s,
            a.coverage.glyphs.splice(s, 0, o),
        ...
        ,
        Lt.prototype.addLigature = function(e, t, r, n) {
        ...
        ,
        Lt.prototype.getFeature = function(e, t, r) {
            if (/ss\d\d/.test(e))
        ...
        ,
        Lt.prototype.add = function(e, t, r, n) {
            if (/ss\d\d/.test(e))
        ...
        var Pt, Nt, Ht, zt, Wt = {
            ...
            parse: function(e, t, r, n, a) {
                return a.lowMemory ? function(e, t, r, n) {
                    var a = new Ue.GlyphSet(n);
                    return n._push = function(o) {
                        var s = r[o];
                        s !== r[o + 1] ? a.push(o, Ue.ttfGlyphLoader(n, o, Gt, e, t + s, At)) : a.push(o, Ue.glyphLoader(n, o))
                    }
                    ,
                    a
          ...
          , Kt = {
            ...
            interpolate: function(e, t, r, n) {
                ...
                if (!n || n === this)
                    ...
                    u = t.x - t.xo,
                    p = r.x - r.xo,
                    0 === (l = (s = Math.abs(a)) + (i = Math.abs(o))) ? void (e.x = e.xo + (u + p) / 2) : void (e.x = e.xo + (u * i + p * s) / l);
                a = n.distance(e, t, !0, !0),
                o = n.distance(e, r, !0, !0),
                u = n.distance(t, t, !1, !0),
                p = n.distance(r, r, !1, !0),
                0 !== (l = (s = Math.abs(a)) + (i = Math.abs(o))) ? Kt.setRelative(e, e, (u * i + p * s) / l, n, !0) : Kt.setRelative(e, e, (u + p) / 2, n, !0)
            },
          ...
          , Jt = {
            ...
            interpolate: function(e, t, r, n) {
                ...
                if (!n || n === this)
                    ...
                    u = t.y - t.yo,
                    p = r.y - r.yo,
                    0 === (l = (s = Math.abs(a)) + (i = Math.abs(o))) ? void (e.y = e.yo + (u + p) / 2) : void (e.y = e.yo + (u * i + p * s) / l);
                a = n.distance(e, t, !0, !0),
                o = n.distance(e, r, !0, !0),
                u = n.distance(t, t, !1, !0),
                p = n.distance(r, r, !1, !0),
                0 !== (l = (s = Math.abs(a)) + (i = Math.abs(o))) ? Jt.setRelative(e, e, (u * i + p * s) / l, n, !0) : Jt.setRelative(e, e, (u + p) / 2, n, !0)
            },
            normalSlope: 0,
            setRelative: function(e, t, r, n, a) {
                if (n && n !== this) {
        ...
        function er(e, t) {
            ...
            return t /= r,
            1 === (e /= r) && 0 === t ? Kt : 0 === e && 1 === t ? Jt : new $t(e,t)
        }
        function tr(e, t, r, n) {
        ...
        $t.prototype.distance = function(e, t, r, n) {
            return this.x * Kt.distance(e, t, r, n) + this.y * Jt.distance(e, t, r, n)
        }
        ,
        $t.prototype.interpolate = function(e, t, r, n) {
            ...
            0 !== (l = (u = Math.abs(s)) + (p = Math.abs(i))) ? this.setRelative(e, e, (a * p + o * u) / l, n, !0) : this.setRelative(e, e, (a + o) / 2, n, !0)
        }
        ,
        ...
        function hr(e) {
            exports.DEBUG && console.log(e.step, "POP[]"),
            e.stack.pop()
        }
        function fr(e, t) {
            var r = t.stack.pop()
        ...
        function dr(e, t) {
            ...
            for (var i = 0; i < s; i++)
                r = o[i],
                !e.touched(r) && ((n = r.prevTouched(e)) !== r && (n === (a = r.nextTouched(e)) && e.setRelative(r, r, e.distance(n, n, !1, !0), e, !0),
        ...
        function gr(e, t) {
            for (var r = t.stack, n = e ? t.rp1 : t.rp2, a = (e ? t.z0 : t.z1)[n], o = t.fv, s = t.pv, i = t.loop, u = t.z2; i--; ) {
                ...
                o.touch(l),
                exports.DEBUG && console.log(t.step, (t.loop > 1 ? "loop " + (t.loop - i) + ": " : "") + "SHP[" + (e ? "rp1" : "rp2") + "]", p)
            }
            t.loop = 1
        }
        function vr(e, t) {
            ...
            do {
                p !== a && o.setRelative(p, p, l, s),
                p = p.nextPointOnContour
            } while (p !== u)
        }
        function mr(e, t) {
            var r, n = t.stack, a = e ? t.rp1 : t.rp2, o = (e ? t.z0 : t.z1)[a], s = t.fv, i = t.pv, u = n.pop();
            switch (exports.DEBUG && console.log(t.step, "SHZ[" + e + "]", u),
            u) {
            case 0:
                r = t.tZone;
                break;
            ...
            for (var p, l = i.distance(o, o, !1, !0), c = r.length - 2, h = 0; h < c; h++)
                p = r[h],
                s.setRelative(p, p, l, i)
        }
        function yr(e, t) {
            var r = t.stack
              , n = r.pop() / 64
        ...
        function Lr(e, t, r, n, a, o) {
            var s, i, u, p, l = o.stack, c = e && l.pop(), h = l.pop(), f = o.rp0, d = o.z0[f], g = o.z1[h], v = o.minDis, m = o.fv, y = o.dpv;
            u = (i = s = y.distance(g, d, !0, !0)) >= 0 ? 1 : -1,
            i = Math.abs(i),
            e && (p = o.cvt[c],
            n && Math.abs(i - p) < o.cvCutIn && (i = p)),
            r && i < v && (i = v),
            n && (i = o.round(i)),
            m.setRelative(g, d, u * i, y),
            m.touch(g),
            exports.DEBUG && console.log(o.step, (e ? "MIRP[" : "MDRP[") + (t ? "M" : "m") + (r ? ">" : "_") + (n ? "R" : "_") + (0 === a ? "Gr" : 1 === a ? "Bl" : 2 === a ? "Wh" : "") + "]", e ? c + "(" + o.cvt[c] + "," + p + ")" : "", h, "(d =", s, "->", u * i, ")"),
            o.rp1 = o.rp0,
            o.rp2 = h,
            t && (o.rp0 = h)
        }
        ...
        function Vr(e, t) {
            ...
            if (e.lookahead.length < t.lookaheadCoverage.length)
                return [];
            for (var o = e.lookahead.slice(a); o.length && Pr(o[0].char); )
                o.shift();
            var s = new Ir(o,0)
              , i = Xr(t.lookaheadCoverage, s)
              , u = [].concat(e.backtrack);
            for (u.reverse(); u.length && Pr(u[0].char); )
                u.shift();
            ...
            var p = new Ir(u,0)
              ...
              , c = [];
            if (n.length === t.inputCoverage.length && i.length === t.lookaheadCoverage.length && l.length === t.backtrackCoverage.length)
                for (var h = 0; h < t.lookupRecords.length; h++)
                    for (var f = t.lookupRecords[h].lookupListIndex, d = this.getLookupByIndex(f), g = 0; g < d.subtables.length; g++) {
                        var v = d.subtables[g]
        ...
        function Yr(e, t) {
            var r = Wr(e.current, t.coverage);
            if (-1 === r)
                return null;
            for (var n, a = t.ligatureSets[r], o = 0; o < a.length; o++) {
                n = a[o];
                for (var s = 0; s < n.components.length; s++) {
                    if (e.lookahead[s] !== n.components[s])
                        break;
                    if (s === n.components.length - 1)
                        return n
                }
            }
            return null
        ...
        qt.prototype.exec = function(e, t) {
            if ("number" != typeof t)
            ...
            if (!(this._errorState > 2)) {
                ...
                if (!n || n.ppem !== t) {
                    ...
                    if (!a) {
                        ...
                        try {
                            ...
                            return console.log("Hinting error in FPGM:" + p),
                    ...
                    var o = r.tables.cvt;
                    if (o)
                        for (var s = n.cvt = new Array(o.length), i = t / r.unitsPerEm, u = 0; u < o.length; u++)
                            s[u] = o[u] * i;
                    else
                        n.cvt = [];
                ...
                if (!(this._errorState > 1))
                    try {
                        ...
                        return this._errorState < 1 && (console.log("Hinting error:" + p),
        ...
        Ht = function(e, t) {
            ...
            i) {
                ...
                for (var p = 0; p < i.length; p++) {
                    ...
                    exports.DEBUG && (console.log("---EXEC COMP " + p + "---"),
                    a.step = -1),
                    zt(c, a, o, s);
                    for (var h = Math.round(l.dx * o), f = Math.round(l.dy * s), d = a.gZone, g = a.contours, v = 0; v < d.length; v++) {
                        var m = d[v];
                ...
                e.instructions && !a.inhibitGridFit && ((a = new ar("glyf",e.instructions)).gZone = a.z0 = a.z1 = a.z2 = n,
                a.contours = r,
        ...
        ,
        zt = function(e, t, r, n) {
            for (var a, o = e.points || [], s = o.length, i = t.gZone = t.z0 = t.z1 = t.z2 = [], u = t.contours = [], p = 0; p < s; p++)
                a = o[p],
                i[p] = new tr(a.x * r,a.y * n,a.lastPointOfContour,a.onCurve);
            for (var l, c, h = 0; h < s; h++)
                a = i[h],
                l || (l = a,
                u.push(h)),
                a.lastPointOfContour ? (a.nextPointOnContour = l,
                l.prevPointOnContour = a,
                l = void 0) : (c = i[h + 1],
                a.nextPointOnContour = c,
                c.prevPointOnContour = a);
            if (!t.inhibitGridFit) {
                if (exports.DEBUG) {
                ...
                if (i.push(new tr(0,0), new tr(Math.round(e.advanceWidth * r),0)),
                Nt(t),
                i.length -= 2,
                exports.DEBUG) {
        ...
        ,
        Pt = [ir.bind(void 0, Jt), ir.bind(void 0, Kt), ur.bind(void 0, Jt), ur.bind(void 0, Kt), pr.bind(void 0, Jt), pr.bind(void 0, Kt), lr.bind(void 0, 0), lr.bind(void 0, 1), cr.bind(void 0, 0), cr.bind(void 0, 1), function(e) {
            var t = e.stack
              , r = t.pop()
              , n = t.pop();
        ...
        , function(e) {
            var t = e.stack.pop();
            switch (exports.DEBUG && console.log(e.step, "SZP0[]", t),
            e.zp0 = t,
            t) {
            case 0:
                e.tZone || or(e),
        ...
        , function(e) {
            var t = e.stack.pop();
            switch (exports.DEBUG && console.log(e.step, "SZP1[]", t),
            e.zp1 = t,
            t) {
            case 0:
                e.tZone || or(e),
        ...
        , function(e) {
            var t = e.stack.pop();
            switch (exports.DEBUG && console.log(e.step, "SZP2[]", t),
            e.zp2 = t,
            t) {
            case 0:
                e.tZone || or(e),
        ...
        , function(e) {
            var t = e.stack.pop();
            switch (exports.DEBUG && console.log(e.step, "SZPS[]", t),
            e.zp0 = e.zp1 = e.zp2 = t,
            t) {
            case 0:
                e.tZone || or(e),
        ...
        , function(e) {
            exports.DEBUG && console.log(e.step, "RTG[]"),
            e.round = Xt
        }
        , function(e) {
        ...
        , function(e) {
            exports.DEBUG && console.log(e.step, "ELSE[]"),
            sr(e, !1)
        }
        , function(e) {
            var t = e.stack.pop();
        ...
        , function(e) {
            ...
            for (exports.DEBUG && console.log(e.step, "FDEF[]", a); 45 !== r[++n]; )
                ;
            e.ip = n,
            e.funcs[a] = r.slice(o + 1, n)
        }
        , void 0, fr.bind(void 0, 0), fr.bind(void 0, 1), dr.bind(void 0, Jt), dr.bind(void 0, Kt), gr.bind(void 0, 0), gr.bind(void 0, 1), vr.bind(void 0, 0), vr.bind(void 0, 1), mr.bind(void 0, 0), mr.bind(void 0, 1), function(e) {
            for (var t = e.stack, r = e.loop, n = e.fv, a = t.pop() / 64, o = e.z2; r--; ) {
                var s = t.pop()
                  , i = o[s];
                exports.DEBUG && console.log(e.step, (e.loop > 1 ? "loop " + (e.loop - r) + ": " : "") + "SHPIX[]", s, a),
                n.setRelative(i, i, a),
                n.touch(i)
            }
            e.loop = 1
        ...
        , function(e) {
            for (var t = e.stack, r = e.rp1, n = e.rp2, a = e.loop, o = e.z0[r], s = e.z1[n], i = e.fv, u = e.dpv, p = e.z2; a--; ) {
                var l = t.pop()
                  , c = p[l];
                exports.DEBUG && console.log(e.step, (e.loop > 1 ? "loop " + (e.loop - a) + ": " : "") + "IP[]", l, r, "<->", n),
                i.interpolate(c, o, s, u),
                i.touch(c)
            }
            e.loop = 1
        }
        , yr.bind(void 0, 0), yr.bind(void 0, 1), function(e) {
            for (var t = e.stack, r = e.rp0, n = e.z0[r], a = e.loop, o = e.fv, s = e.pv, i = e.z1; a--; ) {
                var u = t.pop()
                  , p = i[u];
                exports.DEBUG && console.log(e.step, (e.loop > 1 ? "loop " + (e.loop - a) + ": " : "") + "ALIGNRP[]", u),
        ...
        , function(e) {
            ...
            var n = t.pop()
              , a = t.pop();
            exports.DEBUG && console.log(e.step, "WS", n, a),
            r[a] = n
        }
        , function(e) {
            var t = e.stack
        ...
        , xr.bind(void 0, 0), xr.bind(void 0, 1), void 0, Sr.bind(void 0, 0), Sr.bind(void 0, 1), function(e) {
        ...
        , function(e) {
            var t = e.stack
              , r = t.pop();
            exports.DEBUG && console.log(e.step, "NEG[]", r),
            t.push(-r)
        }
        , function(e) {
            var t = e.stack
        ...
        , kr.bind(void 0, 0), kr.bind(void 0, 1), kr.bind(void 0, 2), kr.bind(void 0, 3), void 0, void 0, void 0, void 0, function(e) {
            var t = e.stack
              , r = t.pop()
              , n = t.pop();
        ...
        , Tr.bind(void 0, 2), Tr.bind(void 0, 3), Ur.bind(void 0, 1), Ur.bind(void 0, 2), Ur.bind(void 0, 3), function(e) {
            var t, r = e.stack.pop();
            switch (exports.DEBUG && console.log(e.step, "SROUND[]", r),
            e.round = Qt,
            192 & r) {
            case 0:
                t = .5;
            ...
            r &= 15,
            e.srThreshold = 0 === r ? 0 : (r / 8 - .5) * t
        }
        , function(e) {
            var t, r = e.stack.pop();
            switch (exports.DEBUG && console.log(e.step, "S45ROUND[]", r),
            e.round = Qt,
            192 & r) {
            case 0:
                t = Math.sqrt(2) / 2;
        ...
        , hr, hr, void 0, void 0, void 0, void 0, void 0, function(e) {
            var t = e.stack.pop();
            exports.DEBUG && console.log(e.step, "SCANCTRL[]", t)
        }
        , Or.bind(void 0, 0), Or.bind(void 0, 1), function(e) {
            var t = e.stack
              , r = t.pop()
              , n = 0;
        ...
        , function(e) {
            var t = e.stack.pop()
              , r = e.stack.pop();
            switch (exports.DEBUG && console.log(e.step, "INSTCTRL[]", t, r),
            t) {
            case 1:
        ...
        ,
        Cr.prototype.getState = function(e) {
            return this.state[e] || null
        }
        ,
        Br.prototype.inboundIndex = function(e) {
            return e >= 0 && e < this.tokens.length
        }
        ,
        Br.prototype.composeRUD = function(e) {
            var t = this
              , r = e.map((function(e) {
        ...
        ,
        Br.prototype.replaceRange = function(e, t, r, n) {
            ...
            if (!isNaN(e) && this.inboundIndex(e) && a) {
                ...
                return n || this.dispatch("replaceToken", [e, t, r]),
                [o, r]
            }
            return {
        ...
        ,
        Br.prototype.replaceToken = function(e, t, r) {
            if (!isNaN(e) && this.inboundIndex(e) && t instanceof Cr) {
        ...
        ,
        Br.prototype.removeRange = function(e, t, r) {
            t = isNaN(t) ? this.tokens.length : t;
            var n = this.tokens.splice(e, t);
            return r || this.dispatch("removeRange", [n, e, t]),
            n
        }
        ,
        Br.prototype.removeToken = function(e, t) {
        ...
        ,
        Br.prototype.insertToken = function(e, t, r) {
        ...
        ,
        Br.prototype.registerModifier = function(e, t, r) {
        ...
        ,
        Br.prototype.rangeToText = function(e) {
            if (e instanceof wr)
        ...
        ,
        Br.prototype.getContext = function(e) {
        ...
        ,
        Br.prototype.dispatch = function(e, t) {
            var r = this
              , n = this.events[e];
            n instanceof Mr && n.subscribers.forEach((function(e) {
                e.apply(r, t || [])
            }
            ))
        }
        ,
        Br.prototype.registerContextChecker = function(e, t, r) {
            ...
            var n = new Dr(e,t,r);
            return this.registeredContexts[e] = n,
            this.contextCheckers.push(n),
            n
        }
        ,
        Br.prototype.getRangeTokens = function(e) {
            var t = e.startIndex + e.endOffset;
            return [].concat(this.tokens.slice(e.startIndex, t))
        }
        ,
        Br.prototype.getContextRanges = function(e) {
        ...
        ,
        Br.prototype.resetContextsRanges = function() {
        ...
        ,
        Br.prototype.updateContextsRanges = function() {
        ...
        ,
        Br.prototype.tokenize = function(e) {
            this.tokens = [],
            this.resetContextsRanges();
            var t = Array.from(e);
            this.dispatch("start");
            ...
            for (var t = this.font.tables.gsub.scripts, r = 0; r < t.length; r++) {
                ...
                if (a)
                    for (var o = 0; o < a.length; o++) {
                        var s = a[o];
                        if (s.tag === e)
                            return s.langSys.featureIndexes
                    }
            }
            return this.getDefaultScriptFeaturesIndexes()
        }
        ...
        Hr.prototype.lookupFeature = function(e) {
            ...
            for (var a = this.getFeatureLookups(n), o = [].concat(t.context), s = 0; s < a.length; s++)
                for (var i = a[s], u = this.getLookupSubtables(i), p = 0; p < u.length; p++) {
                    ...
                    switch (c) {
                    case "11":
                        (f = h(t.current)) && o.splice(r, 1, new zr({
                            id: 11,
                            tag: e.tag,
                            substitution: f
                        }));
                    ...
                    case "63":
                        f = h(t),
                        Array.isArray(f) && f.length && o.splice(r, 1, new zr({
                            id: 63,
                            tag: e.tag,
                            substitution: f
                        }));
        ...
        function $r(e) {
            ...
            if (1 !== a.length) {
                var o = new Ir(a.map((function(e) {
                    return e.getState("glyphIndex")
                }
                )),0)
                  , s = new Ir(a.map((function(e) {
                    return e.char
                }
                )),0);
                    ...
                    if (!Pr(e.char)) {
                        ...
                        if (-1 !== n.indexOf(u)) {
                            ...
                            l.forEach((function(e, t) {
                                e instanceof zr && (Jr(e, a, t),
                                o.context[t] = e.substitution)
                            }
                            ))
                        }
                    }
        ...
        function en(e, t) {
            return new Ir(e.map((function(e) {
        ...
        function cn() {
            var e = this;
            this.featuresTags.hasOwnProperty("arab") && (ln.call(this),
        ...
        function hn() {
            var e = this
              , t = "arab";
            this.featuresTags.hasOwnProperty(t) && (-1 !== this.featuresTags[t].indexOf("rlig") && (ln.call(this),
            this.tokenizer.getContextRanges("arabicWord").forEach((function(t) {
                tn.call(e, t)
            }
            ))))
        ...
        function fn() {
            var e = this
              , t = "latn";
            this.featuresTags.hasOwnProperty(t) && (-1 !== this.featuresTags[t].indexOf("liga") && (ln.call(this),
        ...
        function dn(e) {
            (e = e || {}).tables = e.tables || {},
            e.empty || (It(e.familyName, "When creating a new Font object, familyName is required."),
            It(e.styleName, "When creating a new Font object, styleName is required."),
            It(e.unitsPerEm, "When creating a new Font object, unitsPerEm is required."),
            It(e.ascender, "When creating a new Font object, ascender is required."),
            It(e.descender <= 0, "When creating a new Font object, negative descender value is required."),
            this.names = {
                fontFamily: {
                    en: e.familyName || " "
                },
            ...
            Object.defineProperty(this, "hinting", {
                get: function() {
                    return this._hinting ? this._hinting : "truetype" === this.outlinesFormat ? this._hinting = new qt(this) : void 0
                }
            })
        }
        function gn(e, t) {
        ...
        on.prototype.applyFeaturesToContexts = function() {
            this.checkContextReady("arabicWord") && (cn.call(this),
            hn.call(this)),
        ...
        dn.prototype.stringToGlyphs = function(e, t) {
            ...
            for (var o = n.getTextGlyphs(e), s = o.length, i = new Array(s), u = this.glyphs.get(0), p = 0; p < s; p += 1)
        ...
        dn.prototype.forEachGlyph = function(e, t, r, n, a, o) {
            ...
            for (var l = 0; l < u.length; l += 1) {
                var c = u[l];
                if (o.call(this, c, t, r, n, a),
                c.advanceWidth && (t += c.advanceWidth * i),
                a.kerning && l < u.length - 1)
                    t += (s ? this.position.getKerningValue(s, c.index, u[l + 1].index) : this.getKerningValue(c, u[l + 1])) * i;
        ...
        var xn = {
          ...
          , Tn = function() {
            var e = this.parseUShort();
            return I.argument(1 === e || 2 === e || 3 === e, "Unsupported CaretValue table version."),
            1 === e ? {
          ...
          , kn = function() {
            return this.parseList(se.pointer(Tn))
        }
          , Un = function() {
            return {
                coverage: this.parsePointer(se.coverage),
                ligGlyphs: this.parseList(se.pointer(kn))
            }
        }
          , On = function() {
            return this.parseUShort(),
            this.parseList(se.pointer(se.coverage))
        };
        var En = {
            parse: function(e, t) {
                var r = new se(e,t = t || 0)
                  , n = r.parseVersion(1);
                I.argument(1 === n || 1.2 === n || 1.3 === n, "Unsupported GDEF table version.");
                var a = {
                    version: n,
                    classDef: r.parsePointer(se.classDef),
                    attachList: r.parsePointer(Sn),
                    ligCaretList: r.parsePointer(Un),
                    markAttachClassDef: r.parsePointer(se.classDef)
                };
                return n >= 1.2 && (a.markGlyphSets = r.parsePointer(On)),
                a
            }
        }
          , Rn = new Array(10);
        Rn[1] = function() {
            ...
            } : void I.assert(!1, "0x" + e.toString(16) + ": GPOS lookup type 1 format must be 1 or 2.")
        }
        ,
        Rn[2] = function() {
            var e = this.offset + this.relativeOffset
              , t = this.parseUShort();
            I.assert(1 === t || 2 === t, "0x" + e.toString(16) + ": GPOS lookup type 2 format must be 1 or 2.");
            ...
            if (1 === t)
                return {
                    ...
                    valueFormat1: n,
                    valueFormat2: a,
                    pairSets: this.parseList(se.pointer(se.list((function() {
                        return {
            ...
            if (2 === t) {
                ...
                return {
                    ...
                    class1Count: i,
                    class2Count: u,
                    classRecords: this.parseList(i, se.list(u, (function() {
                        return {
                            value1: this.parseValueRecord(n),
                            value2: this.parseValueRecord(a)
                        }
        ...
        var Cn = {
            parse: function(e, t) {
                var r = new se(e,t = t || 0)
                  , n = r.parseVersion(1);
                return I.argument(1 === n || 1.1 === n, "Unsupported GPOS table version " + n),
                1 === n ? {
                    version: n,
                    scripts: r.parseScriptList(),
                    features: r.parseFeatureList(),
                    lookups: r.parseLookupList(Rn)
                } : {
                    version: n,
                    scripts: r.parseScriptList(),
                    features: r.parseFeatureList(),
            ...
            make: function(e) {
                return new ee.Table("GPOS",[{
                    ...
                    name: "lookups",
                    type: "TABLE",
                    value: new ee.LookupList(e.lookups,Ln)
                }])
            }
        };
        var wn = {
        ...
        var Dn = {
            parse: function(e, t, r, n) {
                for (var a = new ue.Parser(e,t), o = n ? a.parseUShort : a.parseULong, s = [], i = 0; i < r + 1; i += 1) {
                    var u = o.call(a);
                    n && (u *= 2),
                    s.push(u)
                }
        ...
        function Fn(e, t) {
            ...
            var n, a, o, s = new dn({
                empty: !0
            }), i = new DataView(e,0), u = [], p = ue.getTag(i, 0);
            if (p === String.fromCharCode(0, 1, 0, 0) || "true" === p || "typ1" === p)
                s.outlinesFormat = "truetype",
                u = Gn(i, o = ue.getUShort(i, 4));
            else if ("OTTO" === p)
                ...
                u = function(e, t) {
                    ...
                    return r
                }(i, o = ue.getUShort(i, 12))
            }
            for (var c, h, f, d, g, v, m, y, b, x, S, T, k = 0; k < o; k += 1) {
                var U = u[k]
                  , O = void 0;
                switch (U.tag) {
                case "cmap":
                    O = Bn(i, U),
                    s.tables.cmap = le.parse(O.data, O.offset),
                    s.encoding = new ve(s.tables.cmap);
                    break;
                case "cvt ":
                    O = Bn(i, U),
                    T = new ue.Parser(O.data,O.offset),
                    s.tables.cvt = T.parseShortList(U.length / 2);
                    break;
                case "fvar":
                    h = U;
                    break;
                case "fpgm":
                    O = Bn(i, U),
                    T = new ue.Parser(O.data,O.offset),
                    s.tables.fpgm = T.parseByteList(U.length);
                    break;
                case "head":
                    O = Bn(i, U),
                    s.tables.head = _e.parse(O.data, O.offset),
                    s.unitsPerEm = s.tables.head.unitsPerEm,
                    n = s.tables.head.indexToLocFormat;
                    break;
                case "hhea":
                    O = Bn(i, U),
                    s.tables.hhea = Xe.parse(O.data, O.offset),
                ...
                case "ltag":
                    O = Bn(i, U),
                    a = Ye.parse(O.data, O.offset);
                    break;
                case "maxp":
                    O = Bn(i, U),
                    s.tables.maxp = je.parse(O.data, O.offset),
                ...
                case "OS/2":
                    O = Bn(i, U),
                    s.tables.os2 = pt.parse(O.data, O.offset);
                    break;
                case "post":
                    O = Bn(i, U),
                    s.tables.post = lt.parse(O.data, O.offset),
                    s.glyphNames = new ye(s.tables.post);
                    break;
                case "prep":
                    O = Bn(i, U),
                    T = new ue.Parser(O.data,O.offset),
                    s.tables.prep = T.parseByteList(U.length);
                    break;
                case "glyf":
                    f = U;
                    break;
            ...
            var E = Bn(i, x);
            if (s.tables.name = it.parse(E.data, E.offset, a),
            s.names = s.tables.name,
            f && b) {
                var R = 0 === n
                  , L = Bn(i, b)
                  , C = Dn.parse(L.data, L.offset, s.numGlyphs, R)
                  , w = Bn(i, f);
                s.glyphs = Wt.parse(w.data, w.offset, C, s, t)
            } else {
                if (!c)
                    throw new Error("Font doesn't contain TrueType or CFF outlines.");
                var D = Bn(i, c);
                qe.parse(D.data, D.offset, s, t)
            }
            var I = Bn(i, m);
            if (Ve.parse(s, I.data, I.offset, s.numberOfHMetrics, s.numGlyphs, s.glyphs, t),
            be(s, t),
            y) {
                var M = Bn(i, y);
                s.kerningPairs = wn.parse(M.data, M.offset)
            } else
                s.kerningPairs = {};
            if (d) {
                var G = Bn(i, d);
                s.tables.gdef = En.parse(G.data, G.offset)
            }
            if (g) {
                var B = Bn(i, g);
                s.tables.gpos = Cn.parse(B.data, B.offset),
                s.position.init()
            }
            if (v) {
                var F = Bn(i, v);
                s.tables.gsub = dt.parse(F.data, F.offset)
            }
            if (h) {
                var A = Bn(i, h);
                s.tables.fvar = xn.parse(A.data, A.offset, s.names)
            }
            if (S) {
                var P = Bn(i, S);
                s.tables.meta = gt.parse(P.data, P.offset),
        ...
        function An(e, t, r) {
            var n;
            r = null !== (n = r) && void 0 !== n ? n : {};
            var a = typeof window > "u" && !r.isUrl ? In : Mn;
        ...
        function Pn(e, t) {
            return Fn(Dt(o().readFileSync(e)), t)
        }
...
//# sourceMappingURL=237.332831ff.chunk.js.map
