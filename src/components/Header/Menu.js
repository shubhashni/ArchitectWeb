  ...
  return (
    <div className="menu-box" 
      ...
      //  backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}
       >
          ...
          leftPart ? 
            <div className="menu-left-part">
              ...
              <div className="mid">
                ...
                <MenuLink to="https://www.behance.net/am-arc" name="behance" txt="Behance" moveLinks={moveLinks} linksOut={linksOut}/>
        ...
        <div className="menu-right-part">
          <Link
            to="/services"
            className={activeRoute === "services" ? "active fi" : "fi"}
      ...
      onMouseEnter={()=> changePointer({isHover: true, color:{bg:"#ffffff", txt: "#000000"}, text: "", blend:true,})}
          ...
          <Link
            to="/faq"
            className={activeRoute === "faq" ? "active las" : "las"}
          ...
          !leftPart ? 
            <div className="bottom-part">
              ...
              <div className="header-socials">
                ...
                {/* Behance */}
                <a href='https://www.behance.net/am-arc' target="_blank" rel="noopener noreferrer">
